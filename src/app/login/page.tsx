  ...
  return (
    <div className="mx-auto flex min-h-[calc(100svh-7.5rem)] w-full max-w-md items-center">
      <div className="w-full space-y-5">
        <section className="app-card-strong overflow-hidden rounded-[28px] border border-neutral-200 bg-white">
          <div className="bg-gradient-to-br from-pink-50 via-white to-sky-50 px-4 py-6 sm:px-6">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">Eventro</p>
            <h1 className="mt-2 text-3xl font-semibold text-slate-950 sm:text-[2.1rem]">Entra a tu cuenta</h1>
